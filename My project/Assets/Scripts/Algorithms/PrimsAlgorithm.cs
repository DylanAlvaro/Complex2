...
namespace Algorithms
{
    public static class PrimsAlgorithm 
    {
        ...
        public Edge(Graphs.Vertex u, Graphs.Vertex v) : base(u, v) {
    ...
    public static List<Edge> MinimumSpanningTree(List<Edge> edges, Graphs.Vertex start) 
    {
        HashSet<Graphs.Vertex> openSet = new HashSet<Graphs.Vertex>();
        HashSet<Graphs.Vertex> closedSet = new HashSet<Graphs.Vertex>();
